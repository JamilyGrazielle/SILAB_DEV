    ...
    <div className="dash-container">
      ...
      <div className="dash-grid-wrapper">
        <div className="dash-grid">
          ...
          <div className="dash-card" style={{border: '1px solid hsl(0, 75%, 70%)'}}>
            <div className="card-icon agenda">
              <svg width="24" height="24" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                <path strokeLinecap="round" strokeLinejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
              </svg>
            </div>
            <h3>Agenda</h3>
            <p>Visualize a agenda semanal de reservas.</p>
            <button className="card-btn red" onClick={() => navigate('/agenda')}>Ver Agenda</button>
          </div>
          ...
          <div className="dash-card" style={{border: '1px solid hsl(142, 76%, 70%)'}}>
            ...
            {perfil === 'PROFESSOR' ? (
              <>
                ...
                <p>Crie novas reservas e gerencie seus agendamentos de laboratório.</p>
              </>
            ) : (
              <>

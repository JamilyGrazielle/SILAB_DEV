...
public class TesteConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Usuario u1 = new Usuario(null, "Admin", "12345", "admin@email.com", "senha123", Perfil.ROOT, Status.ATIVO);
        Usuario u2 = new Usuario(null, "Professor", "54321", "prof@email.com", "senha123", Perfil.PROFESSOR, Status.ATIVO);
